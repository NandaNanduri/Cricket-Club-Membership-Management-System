...
function ClubAdminRegisterForm() {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const res = await axios.post('http://127.0.0.1:8000/users/register/club-admin/', payload, {
                headers: {
            ...
            if (err.response?.data) {
                ...
                alert('Error registering club admin!');
            }
        }
    };
            ...
            <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
                <div className="p-8">
                    <div className="text-center mb-8">
                        <h2 className="text-3xl font-extrabold text-gray-900">Club Admin Registration</h2>
                        <p className="mt-2 text-sm text-gray-600">Please fill in the club admin details</p>
                    </div>
...
export default ClubAdminRegisterForm;